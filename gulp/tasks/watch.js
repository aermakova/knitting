module.exports = function() {
    $.gulp.task("watch", function() {
        return new Promise((res, rej) => {
            $.watch(["./src/views/**/index.html", "./src/views/**/*.html", "!./src/views/blocks/*.html"], $.gulp.series("html"));
            $.watch("./src/styles/**/main.scss", "./src/styles/partials/*.scss", $.gulp.series("styles"));
